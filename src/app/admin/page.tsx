...
import { Users, ShieldCheck, BookOpen, Brain, Search, Loader2, Edit3, X, Star, ExternalLink, Check, Award, Activity, KeyRound, AlertCircle, Camera, Upload, Trash2, Plus, Shield, Lock, UserPlus, Video, Layout } from "lucide-react";
import { MiroBoardManager } from "@/components/integrations/MiroBoardManager";
import { ZoomMeetingManager } from "@/components/integrations/ZoomMeetingManager";
import { ZoomRecordingPlayer } from "@/components/integrations/ZoomRecordingPlayer";
...
export default function AdminDashboardPage() {
  const [activeTab, setActiveTab] = React.useState<"overview" | "users" | "courses" | "roles" | "integrations">("overview");
  ...
  return (
    <AppShell>
      ...
      <div className="space-y-8 pb-16">
        ...
        {/* TAB 5: INTEGRATIONS (MIRO & ZOOM) */}
        {activeTab === "integrations" && (
          <div className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Miro Integration Card */}
              <div className="p-6 rounded-xl bg-[#111111] border border-white/10 space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-base font-bold text-white">Miro Integration</h3>
                      <p className="text-xs text-[#A3A3A3]">Interactive whiteboards & strategy boards</p>
                    </div>
                  </div>
              ...
              <div className="p-6 rounded-xl bg-[#111111] border border-white/10 space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-base font-bold text-white">Zoom + S3 Recordings</h3>
                      <p className="text-xs text-[#A3A3A3]">Live meetings & auto-archived recordings</p>
                    </div>
                  </div>
                  <span className="px-2.5 py-1 rounded text-[11px] font-bold uppercase tracking-wider bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
                    Active
