  ...
  return (
    <>
      ...
      >
        ...
        {/* Admin Link at Bottom (Matches Bubble App) */}
        {isAdmin && (
          <div className="p-4 border-t border-white/5">
            ...
            >
              <div className="w-7 h-7 rounded-full bg-[#00D1B2]/20 border border-[#00D1B2]/40 flex items-center justify-center text-[#00D1B2]">
